...
TBD - created by archiving change 'audit-i18n-and-a11y'. Update Purpose after archive.
...
tests:
  ...
  - apps/web/src/motion/dialog-focus-trap.test.tsx
  - apps/web/src/auth/LoginPage.test.tsx
  - apps/web/src/a11y/icon-button-audit.test.ts
  - apps/web/src/i18n-audit.test.ts
  - apps/web/src/a11y/use-focus-trap.test.tsx
-->
